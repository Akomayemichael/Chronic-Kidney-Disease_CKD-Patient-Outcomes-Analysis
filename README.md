...
├── README.md
├── sql/
│   ├── CKD_Phase1_Data_Cleaning.sql
│   └── CKD_Phase2_EDA.sql
├── dashboard/
│   └── CKD_Analysis_Dashboard.pbix
├── presentation/
│   └── CKD_Analysis_Presentation.pptx
└── assets/
    ├── dashboard_preview_p1.png
    ├── dashboard_preview_p2.png
    ├── dashboard_preview_p3.png
    ├── dashboard_preview_p4.png
    ├── dashboard_preview_p5.png
    └── dashboard_preview_p6.png
```
...
Full analysis: `sql/CKD_Phase2_EDA.sql`
...
Microsoft Certified Data Analyst-pl300
